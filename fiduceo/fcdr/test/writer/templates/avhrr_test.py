...
class AVHRRTest(unittest.TestCase):
    ...
    def test_add_easy_fcdr_variables(self):
        ...
        self._assert_correct_refl_uncertainty_variable(ds, "u_independent_Ch1", long_name="independent uncertainty per pixel for channel 1", units="1", valid_min=10, valid_max=10000)
        self._assert_correct_refl_uncertainty_variable(ds, "u_structured_Ch1", long_name="structured uncertainty per pixel for channel 1", units="1", valid_min=10, valid_max=10000)
        self._assert_correct_refl_uncertainty_variable(ds, "u_common_Ch1", long_name="common uncertainty per pixel for channel 1", units="percent", valid_min=1, valid_max=1000)
        self._assert_correct_refl_uncertainty_variable(ds, "u_independent_Ch2", long_name="independent uncertainty per pixel for channel 2", units="1", valid_min=10, valid_max=10000)
        self._assert_correct_refl_uncertainty_variable(ds, "u_structured_Ch2", long_name="structured uncertainty per pixel for channel 2", units="1", valid_min=10, valid_max=10000)
        self._assert_correct_refl_uncertainty_variable(ds, "u_common_Ch2", long_name="common uncertainty per pixel for channel 2", units="percent", valid_min=1, valid_max=1000)
        self._assert_correct_refl_uncertainty_variable(ds, "u_independent_Ch3a", long_name="independent uncertainty per pixel for channel 3a", units="1", valid_min=10, valid_max=10000)
        self._assert_correct_refl_uncertainty_variable(ds, "u_structured_Ch3a", long_name="structured uncertainty per pixel for channel 3a", units="1", valid_min=10, valid_max=10000)
        self._assert_correct_refl_uncertainty_variable(ds, "u_common_Ch3a", long_name="common uncertainty per pixel for channel 3a", units="percent", valid_min=1, valid_max=1000)
